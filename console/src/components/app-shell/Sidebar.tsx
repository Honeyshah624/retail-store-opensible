...
export function AppSidebar() {
  ...
  const cicd: Item[] = [
  { to: "/cicd/pipelines", label: "Pipelines", icon: GitBranch },
  { to: "/cicd/runs", label: "Run History", icon: History },
];
  const system: Item[] = [
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-4 text-sm custom-scrollbar">
       ...
       <Section title={t("nav.cicd")} items={cicd} pathname={pathname} collapsed={collapsed} />
